...
var ComboBox = /** @class */ (function (_super) {
    ...
    ComboBox.prototype.render = function () {
        ...
        return label
            ? (React.createElement(FloatingLabel, { label: label, value: inputText, style: { width: style ? style.width : undefined }, valid: isValid, id: this._inputId, children: combobox }))
            : combobox;
    };
    /**
     * @hidden
    ...
    ComboBox.prototype.applyValueOnEnter = function (value, state) {
        ...
        var opened = this.props.opened !== undefined ? this.props.opened : this.state.opened;
        var valueIndex = getItemIndexByText(data, value, textField);
    ...
    ComboBox.prototype.selectFocusedItem = function (text, state) {
        ...
        var focusedItemIndex = (text === '' && skip === 0) ? 0 :
            itemIndexStartsWith(data, text, textField);
    ...
    ComboBox.prototype.renderList = function () {
        ...
        return (React.createElement(List, { id: base.listBoxId, show: opened, data: data, focusedIndex: focusedIndex, value: value, textField: textField, valueField: dataItemKey, optionPrefix: base.optionPrefix, listRef: function (list) { return vs.list = _this.base.list = list; }, wrapperStyle: !vs.enabled ?
    ...
    ComboBox.prototype.getFocusedIndex = function () {
        ...
        if (isPresent(value) && text === undefined) {
            ...
            return itemIndexStartsWith(data, text, textField);
        }
        else {
     ...
     * @hidden
     */
    ComboBox.propTypes = __assign({}, DropDownBase.propTypes, { dataItemKey: PropTypes.string, suggest: PropTypes.bool, placeholder: PropTypes.string, allowCustom: PropTypes.bool, clearButton: PropTypes.bool, iconClassName: PropTypes.string, validationMessage: PropTypes.string, required: PropTypes.bool });
    /**
     * @hidden
     */
