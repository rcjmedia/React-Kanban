...
var ComboBox = /** @class */ (function (_super) {
    ...
    ComboBox.prototype.render = function () {
        var _this = this;
        var _a = this.props, dir = _a.dir, disabled = _a.disabled, clearButton = _a.clearButton, label = _a.label, textField = _a.textField, className = _a.className, style = _a.style, loading = _a.loading, iconClassName = _a.iconClassName, virtual = _a.virtual;
        ...
        return label
            ? (React.createElement(kendo_react_common_1.FloatingLabel, { label: label, value: inputText, style: { width: style ? style.width : undefined }, valid: isValid, id: this._inputId, children: combobox }))
            : combobox;
    };
    /**
     * @hidden
    ...
    ComboBox.prototype.applyValueOnEnter = function (value, state) {
        ...
        var opened = this.props.opened !== undefined ? this.props.opened : this.state.opened;
        var valueIndex = utils_1.getItemIndexByText(data, value, textField);
    ...
    ComboBox.prototype.selectFocusedItem = function (text, state) {
        ...
        var focusedItemIndex = (text === '' && skip === 0) ? 0 :
            utils_1.itemIndexStartsWith(data, text, textField);
    ...
    ComboBox.prototype.renderList = function () {
        ...
        return (React.createElement(List_1.default, { id: base.listBoxId, show: opened, data: data, focusedIndex: focusedIndex, value: value, textField: textField, valueField: dataItemKey, optionPrefix: base.optionPrefix, listRef: function (list) { return vs.list = _this.base.list = list; }, wrapperStyle: !vs.enabled ?
    ...
    ComboBox.prototype.getFocusedIndex = function () {
        ...
        if (utils_1.isPresent(value) && text === undefined) {
            ...
            return utils_1.itemIndexStartsWith(data, text, textField);
        }
        else {
     ...
     * @hidden
     */
    ComboBox.propTypes = __assign({}, DropDownBase_1.default.propTypes, { dataItemKey: PropTypes.string, suggest: PropTypes.bool, placeholder: PropTypes.string, allowCustom: PropTypes.bool, clearButton: PropTypes.bool, iconClassName: PropTypes.string, validationMessage: PropTypes.string, required: PropTypes.bool });
    /**
     * @hidden
     */
